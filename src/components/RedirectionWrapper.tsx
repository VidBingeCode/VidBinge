      ...
      <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-80 z-[1000]">
        <div className="relative bg-purple-950 p-4 md:p-8 rounded-xl shadow-2xl text-center text-white w-11/12 md:w-3/4 lg:w-1/2 xl:w-2/5 2xl:max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-3 md:space-y-4 text-sm md:text-base leading-relaxed text-gray-300">
            <p>
              Hello there, On July 25th 2024 Sudo-Flix.lol announced its closure
              due to a Cease and Desist Letter. You can discover more about this
              at their respective discord server!
            </p>
            <p>
            ...
            <p>
              Our backend has been synced with theirs, ensuring full streamlined
              conversion for our members. This means you can safely use this
              site with all your data securely transferred, using the same login
            ...
            <p>
              Your support would be greatly appreciated during this transition.
              We highly recommend joining our discord server for easier
              communication and support.
            </p>
            <p>
              We apologize for any inconvenience and appreciate your patience at
              this time.
            </p>
            <p>
              With best regards,
